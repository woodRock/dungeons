...
class BattleMode {
public:
  BattleMode(PixelsEngine::Registry *registry,
...
private:
  ...
  void ExecuteAction(PixelsEngine::Entity actor, ActionType action,
                     PixelsEngine::Entity target, float x, float y);
  void UpdateAI(float dt);
  void CheckVictory();

  void DrawActionBar(PixelsEngine::GLRenderer *ren,
                     PixelsEngine::TextRenderer *tr, int w, int h);
  void DrawTurnOrder(PixelsEngine::GLRenderer *ren,
                     PixelsEngine::TextRenderer *tr, int w, int h);
